...
public class Preferences {
    ...
    private static String setting_key_mobile_network_play = "setting_key_mobile_network_play";
    ...
    public static boolean enableMobileNetworkPlay() {
        return getBoolean(setting_key_mobile_network_play, false);
    }
    public static void saveMobileNetworkPlay(boolean enable) {
        saveBoolean(setting_key_mobile_network_play, enable);
    }
//
